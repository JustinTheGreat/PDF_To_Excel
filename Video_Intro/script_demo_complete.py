...
extraction_params = [
    # Basic text extraction with simple start/end keywords
    {
        ...
        "end_keyword": "REPORT NO.",
        "page_num": 0,
        "horiz_margin": 500,
        "end_keyword_occurrence": 1,
        "forced_keywords": ["REPORT NO."]
    },
    {
        "field_name": "Product Tests",
        "start_keyword": "SAMPLE DESCRIPTION",
        "end_keyword": "TEST RESULT(S)",
        "page_num": 0,
        "horiz_margin": 500,
        "end_keyword_occurrence": 1
    },
    {
        "field_name": "Report Notes",
        "start_keyword": "Tested by :",
        "end_keyword": "Notes :",
        "page_num": 1,
        "horiz_margin": 500,
        "end_keyword_occurrence": 1
